...
pixi global install aws-c-mqtt
```
...
It is possible to list all of the versions of `aws-c-mqtt` available on your platform:
...
```
pixi search aws-c-mqtt --channel conda-forge
```
